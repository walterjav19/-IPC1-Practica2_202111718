...
public class Inicio extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 255)), "Panel de Opciones"));

        jLabel3.setText("Algoritmo:");

        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "burbuja", "inserción", "selección" }));
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        Archivo admin = new Archivo();
        
        String text=admin.obtenerTexto(ruta);
